...
};console.log("%c\uD83C\uDF4A%c Shikwasa Podcast Player v2.0.0-beta.1 %c https://shikwasa.js.org", 'background-color:#00869B40;padding:4px;', 'background:#00869B80;color:#fff;padding:4px 0', 'padding: 2px 0;');
